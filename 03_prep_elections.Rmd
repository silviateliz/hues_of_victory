...
dep <- read_csv("data/raw_files/election_results/DIP_FED_2024.csv") %>% 
...
sen <- read_csv("data/raw_files/election_results/SEN_2024.csv")%>% 
  select(-c("CLAVE_CASILLA", "SECCION", "ID_CASILLA", "TIPO_CASILLA", "EXT_CONTIGUA", "CASILLA", "TIPO_ACTA", "OBSERVACIONES", "MECANISMOS_TRASLADO", "FECHA_HORA"))


pres <- read_csv("data/raw_files/election_results/PRES_2024.csv")%>% 
  select(-c("CLAVE_CASILLA", "SECCION", "ID_CASILLA", "TIPO_CASILLA", "EXT_CONTIGUA", "CASILLA", "TIPO_ACTA", "OBSERVACIONES", "MECANISMOS_TRASLADO", "FECHA_HORA"))
```
...
write_csv(dep_cand_results, "data/03_dep_cand_results.csv")
write_csv(sen_cand_results, "data/03_sen_cand_results.csv")
write_csv(pres_cand_results, "data/03_pres_cand_results.csv")
